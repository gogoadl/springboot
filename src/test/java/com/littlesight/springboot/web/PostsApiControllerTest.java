...
public class PostsApiControllerTest {
    ...
    @Autowired
    private PostsRepository postsReporitory;
    ...
    public void Posts_regist() throws Exception
    {
        ...
        List<Posts> all = postsReporitory.findAll();
    ...
    public void Posts_update() throws Exception {
        ...
        Posts savedPosts = postsReporitory.save(Posts.builder()
                .title("title")
                .content("content")
                .author("author")
                .build());
        ...
        List<Posts> all = postsReporitory.findAll();
        assertThat(all.get(0).getTitle()).isEqualTo(expectdTitle);
